...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        if (cmd.show_help || cmd.command.empty()) {
            ...
            args.emplace_back(UseMultiprocess(cmd) ? "freicoin-gui" : "freicoin-qt");
        } else if (cmd.command == "node") {
            args.emplace_back(UseMultiprocess(cmd) ? "freicoin-node" : "freicoind");
        } else if (cmd.command == "rpc") {
            args.emplace_back("freicoin-cli");
            ...
            args.emplace_back("freicoin-util");
        } else {
