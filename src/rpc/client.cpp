...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "utxoupdatepst", 0, "pst", ParamFormat::STRING },
    ...
    { "createrawtransaction", 5, "version" },
    ...
    { "walletcreatefundedpst", 6, "version" },
    { "walletprocesspst", 0, "pst", ParamFormat::STRING },
    { "walletprocesspst", 1, "sign" },
    { "walletprocesspst", 3, "bip32derivs" },
    { "walletprocesspst", 4, "finalize" },
    { "descriptorprocesspst", 0, "pst", ParamFormat::STRING },
    ...
    { "combinepst", 0, "txs"},
    { "joinpsts", 0, "txs"},
    { "finalizepst", 0, "pst", ParamFormat::STRING },
    ...
    { "decodepst", 0, "pst", ParamFormat::STRING },
    { "analyzepst", 0, "pst", ParamFormat::STRING},
