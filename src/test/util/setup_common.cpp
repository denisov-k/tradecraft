...
std::vector<CTransactionRef> TestChain100Setup::PopulateMempool(FastRandomContext& det_rand, size_t num_transactions, bool submit)
{
    ...
    std::deque<std::tuple<COutPoint, CAmount, uint32_t>> unspent_prevouts, undo_info;
    ...
    while (num_transactions > 0 && !unspent_prevouts.empty()) {
        ...
        for (size_t n{0}; n < num_inputs; ++n) {
            ...
            undo_info.emplace_back(prevout, amount, refheight);
        ...
        if (submit) {
            ...
            if (changeset->CheckMemPoolPolicyLimits()) {
                ...
                for (const auto& [prevout, amount, refheight] : undo_info) {
                    unspent_prevouts.emplace_back(prevout, amount, refheight);
