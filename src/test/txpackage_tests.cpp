...
BOOST_AUTO_TEST_CASE(package_hash_tests)
{
    ...
    constexpr Wtxid wtxid_1{"2bea976bb2cc14b521d70273df015fe55ac721f8378dc113f3b92b30d8825226"};
    constexpr Wtxid wtxid_2{"37c0b439a77e1f2af3d354ab7056195369bdbd3651aeb8a705a6262c74c7990f"};
    constexpr Wtxid wtxid_3{"a4846c0556722f30bf36ebc0bc63ff57728ba4b5a064a420bcb35b69f140f8f0"};
    ...
    constexpr Txid txid_1{"ff0f4cbdd3cde82edfee3cbe3d88d54f97a85a95ca0211b2f7c6230b23b79d76"};
    constexpr Txid txid_2{"37c0b439a77e1f2af3d354ab7056195369bdbd3651aeb8a705a6262c74c7990f"};
    constexpr Txid txid_3{"cc0ab94791af3f3ef4293a6655f6f2a1635af73f3a229dda82ee0ed13a46f9ed"};
...
BOOST_AUTO_TEST_CASE(package_submission_tests)
{
    ...
    // In-mempool parent and child with missing parent.
    {
        ...
        auto tx_parent_2 = MakeTransactionRef(CreateValidMempoolTransaction(/*input_transaction=*/m_coinbase_txns[2], /*input_vout=*/0,
                                                                            /*input_height=*/0, /*input_signing_key=*/coinbaseKey,
                                                                            /*output_destination=*/parent_locking_script,
                                                                            /*output_amount=*/CAmount(50 * COIN - 900), /*submit=*/false));
