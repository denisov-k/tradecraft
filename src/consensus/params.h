...
struct Params {
    ...
    // mining). enforce_BIP94 kept from Core 29 (referenced by pow.cpp /
    // validation.cpp / chainparams.cpp); its interaction with Freicoin's
    // custom difficulty adjustment is a design decision for the maintainer.
    /**
