...
public:
    explicit CMainParams(const CChainParams::MainNetOptions& opts) {
        ...
        // Freiland Harberger covenant: not scheduled on mainnet yet (decide after signet proof).
...
public:
    explicit CTestNetParams(const CChainParams::TestNetOptions& opts) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_FINALTX].min_activation_height = 0; // No activation delay
        consensus.vDeployments[Consensus::DEPLOYMENT_FINALTX].threshold = 378;
        consensus.vDeployments[Consensus::DEPLOYMENT_FINALTX].period = 504;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_AUXPOW].nTimeout = 1622592000; // June 2nd, 2021.
        consensus.vDeployments[Consensus::DEPLOYMENT_AUXPOW].min_activation_height = 0; // No activation delay
        consensus.vDeployments[Consensus::DEPLOYMENT_AUXPOW].threshold = 378;
        consensus.vDeployments[Consensus::DEPLOYMENT_AUXPOW].period = 504;
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.harberger_activation_time = 1784884000;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // Freiland Harberger covenant: ACTIVE from genesis on regtest (covenant functional tests),
        // unless -harbergeractivationtime overrides it (to test the pre-activation window / edge).
        consensus.harberger_activation_time = opts.harberger_activation_time.value_or(0);
