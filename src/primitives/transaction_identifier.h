...
#ifndef FREICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define FREICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // FREICOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
